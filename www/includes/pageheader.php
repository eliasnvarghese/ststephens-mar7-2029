<header class="header2">
	...
	<nav class="style2">
		...
		<div class="container">
			<div class="logo">
				<a href="index.php" title="Home"><img src="images/logo/logo1.png" alt="" /></a>
			</div><!--- LOGO -->
			<ul>
				<li><a href="index.php" title=""><i class="fa fa-home fa-fw" aria-hidden="true"></i>Home</a>
				</li>
				<li><a href="photogallery.php" title="">Photos</a>
				</li>
				<li><a href="videogallery.php" title="">Videos</a>
				</li>
				<li class="menu-item-has-children"><a href="#" title="">About</a>
				<ul>
          <li><a href="boardoftrustees.php" title="">Board of Trustees</a></li>
...
<div class="responsive-menu">
	<ul>
		...
		<ul>
			...
			<li><a href="ministries.php" title="">Organizations</a></li>
      <li><a href="ministries.php" title="">Board of Trustees</a></li>
		</ul>
		</li>
