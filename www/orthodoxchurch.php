...
<head>
  ...
  <title>Syriac Orthodox Church</title>
...
<body>
  <div class="theme-layout">
    ...
    <div class="page-top">
      ...
      <div class="container">
        <h1>SYRIAC ORTHODOX <span>CHURCH</span></h1>
        <ul>
      ...
      <div class="block">
        <div class="container">
          <div class="row">
            <div class="title">
              <span></span>
              <h2><span>A Brief Overview Of The Holy Syriac Orthodox Church</span></h2>
            </div>
            <div class="about">
              <div class="col-md-12 column">
                ...
                <div class="title">
                  <span></span>
                  <h2><span>Faith and Doctrine</span></h2>
                </div>
                <p style="font-size:14px">
                ...
                <div class="title">
                  <span></span>
                  <h2><span>Form of Worship</span></h2>
                </div>
                <p style="font-size:14px">
                ...
                <div class="title">
                  <span></span>
                  <h2><span>Church Hierarchy</span></h2>
                </div>
                <p style="font-size:14px">
                ...
                <p style="font-size:14px">
                  <li><i class="fa fa-check-square-o"></i> Episcopate: Within it there are the ranks of Patriarch, Catholicose, Archbishop, and Bishop.</li>
                  <li><i class="fa fa-check-square-o"></i> Vicarate: Within it there are the ranks of Chor-episcopos and Priest or qasheesho.</li>
                  <li><i class="fa fa-check-square-o"></i> Deaconate: Within it there are the ranks of Archdeacon, Evangelical-Deacon (M’shamshono), Subdeacon (Apodyaqno), Reader (Qoruyo) and Singer (Mzamrono).</li>
                ...
                <p style="font-size:14px">
                  Source:Syriac Orthodox Resources
                </p>
